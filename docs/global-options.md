...
```bash
# -- Terraform --
# mkdir -p /usr/share/terraform/plugins/registry.terraform.io/bischoff/feilong/0.0.10/linux_amd64/
# cd /usr/share/terraform/plugins/registry.terraform.io/bischoff/feilong/0.0.10/linux_amd64/
# ln -s /home/someuser/bin/terraform-provider-feilong
# -- OpenTofu --
# mkdir -p /usr/share/terraform/plugins/registry.opentofu.org/bischoff/feilong/0.0.10/linux_amd64/
# cd /usr/share/terraform/plugins/registry.opentofu.org/bischoff/feilong/0.0.10/linux_amd64/
 ...
 * `admin_token` (optional): the secret shared with the z/VM connector for authentication, in case this was set up. See the [Token Usage](https://feilong.readthedocs.io/en/latest/setuphttpd.html#token-usage) chapter of the Feilong documentation for more information on how to set this up. If you don't want to store it in the `main.tf` file, you can use [Terraform variables](https://developer.hashicorp.com/terraform/language/values/variables) to pass it at run time.
